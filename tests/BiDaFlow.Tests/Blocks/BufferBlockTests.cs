...
namespace BiDaFlow.Tests.Blocks
{
    ...
    public class BufferBlockTests
    {
        ...
        public async Task TestFastProducerMultiConsumerStressTest()
        {
            ...
            var testBlock1 = new BufferBlock<int>(new DataflowBlockOptions() { BoundedCapacity = 1 });
            var testBlock2 = new BufferBlock<int>(new DataflowBlockOptions() { BoundedCapacity = 1 });
